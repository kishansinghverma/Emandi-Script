...
css.innerHTML = "br {display: block; content: \"\"; margin-top: 8px; } .head { display: flex; justify-content: space-between; margin-bottom: 4px } .close { border-radius: 8px; color: red; } #myModal { display: block; padding: 10px; border-radius:4px; position: fixed; z-index: 100; margin-top:100px; top: 0; background-color: rgb(0 0 0 / 72%); } #zContent{ background-color: #fefefe; border-radius:4px; padding: 20px; border: 1px solid #888; display: flex; flex-direction: column; align-items: center; justify-content: center; }";
