...
var modals = {
    'add_six_r': '<div id="myModal"><div id="zContent"><div><button onclick="hide(\'myModal\')">x</button></div><br><input type="text" id="sname" placeholder="Seller Name" /><br><input type="text" id="quantity" placeholder="Quantity (In Quintals)" /><br><div id="img-captcha"></div><br><input type="text" placeholder="Captcha Code" id="in-captcha"/><br><button onclick="mSubmit()">Submit</button></div></div>',
