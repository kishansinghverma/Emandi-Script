...
var scripts = {
    ...
    'DigitalPayment': "let wait = setInterval(() => { if (document.querySelector('#datatable1 > tbody').childElementCount > 0) { if (document.getElementsByClassName('chk').length > 0) { clearInterval(wait); document.getElementsByClassName('chk')[0].click(); document.getElementById('proceddnow').click(); } } else { alert('No Payment Pending') } }, 1000);",
