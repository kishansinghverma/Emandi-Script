...
var scripts = {
    ...
    'DigitalPayment': "let wait = setInterval(()=>{ if( document.getElementsByClassName('chk') != undefined ) { clearInterval(wait); document.getElementsByClassName('chk')[0].click(); document.getElementById('proceddnow').click(); } }, 1000);",
